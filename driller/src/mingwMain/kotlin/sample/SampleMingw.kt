...
//private suspend fun xx(): String {
//    println("in the routine")
//    val client = HttpClient()
//    println("client created")
//
//    val json = io.ktor.client.features.json.defaultSerializer()
//    val hey = client.post<String>() {
//        url("http://127.0.0.1:9898/result")
//        body = json.write("{\"msg\": \"salut\"}") // Generates an OutgoingContent
//    }
//
